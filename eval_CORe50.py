...
for episode in range(4):
    results[episode] = {}
    for do in range(5):
        command = f'python eval.py --dataset CORe50 --load_path {base_path}_do_{do}/episode_{episode}.model --mode OWR_eval --eval_episode {episode} --dataorder {do} {other_params}'
